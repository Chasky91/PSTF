 ...
 */
class Modulo extends \Application\Entity\Modulo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'idModulo', 'nombre');
        }
